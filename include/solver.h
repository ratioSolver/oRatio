...
namespace ratio
{
  ...
  inline json::json solver_state_changed_message(const solver &s) noexcept { return {{"type", "state_changed"}, {"id", get_id(s)}, {"state", to_json(s)}, {"timelines", to_timelines(s)}}; }
  inline json::json started_solving_message(const solver &s) noexcept { return {{"type", "started_solving"}, {"id", get_id(s)}}; }
  inline json::json solution_found_message(const solver &s) noexcept { return {{"type", "solution_found"}, {"id", get_id(s)}, {"state", to_json(s)}, {"timelines", to_timelines(s)}}; }
  inline json::json inconsistent_problem_message(const solver &s) noexcept { return {{"type", "inconsistent_problem"}, {"id", get_id(s)}}; }
} // namespace ratio
