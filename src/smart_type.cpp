...
namespace ratio::solver
{
    ...
    atom_listener::atom_listener(ratio::core::atom &atm) : semitone::sat_value_listener(static_cast<solver &>(atm.get_type().get_core()).get_sat_core_ptr()), semitone::lra_value_listener(static_cast<solver &>(atm.get_type().get_core()).get_lra_theory()), semitone::rdl_value_listener(static_cast<solver &>(atm.get_type().get_core()).get_rdl_theory()), semitone::ov_value_listener(static_cast<solver &>(atm.get_type().get_core()).get_ov_theory()), atm(atm)
    {
