...
namespace ratio
{
    reusable_resource::reusable_resource(solver &slv) : smart_type(slv, REUSABLE_RESOURCE_TYPE_NAME)
    {
        ...
        capacity_args.push_back(std::make_unique<riddle::id_expression>(std::vector<riddle::id_token>{riddle::id_token(REUSABLE_RESOURCE_CAPACITY_NAME, 0, 0, 0, 0)}));
        ctr_inits.emplace_back(riddle::id_token(REUSABLE_RESOURCE_CAPACITY_NAME, 0, 0, 0, 0), std::move(capacity_args));
        // we create the constructor's body..
        ctr_body.push_back(std::make_unique<riddle::expression_statement>(std::make_unique<riddle::geq_expression>(std::make_unique<riddle::id_expression>(std::vector<riddle::id_token>{riddle::id_token(REUSABLE_RESOURCE_CAPACITY_NAME, 0, 0, 0, 0)}), std::make_unique<riddle::real_expression>(riddle::real_token(utils::rational::zero, 0, 0, 0, 0)))));
        ...
        use_body.push_back(std::make_unique<riddle::expression_statement>(std::make_unique<riddle::leq_expression>(std::make_unique<riddle::id_expression>(std::vector<riddle::id_token>{riddle::id_token(REUSABLE_RESOURCE_AMOUNT_NAME, 0, 0, 0, 0)}), std::make_unique<riddle::id_expression>(std::vector<riddle::id_token>{riddle::id_token(REUSABLE_RESOURCE_CAPACITY_NAME, 0, 0, 0, 0)}))));
        // we create the `Use` predicate..
        auto use_pred = std::make_unique<riddle::predicate>(*this, REUSABLE_RESOURCE_PREDICATE_NAME, std::move(use_args), use_body);
    ...
    void reusable_resource::new_atom(std::shared_ptr<ratio::atom> &atm)
    {
