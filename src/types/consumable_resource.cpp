...
namespace ratio
{
    consumable_resource::consumable_resource(solver &slv) : smart_type(slv, CONSUMABLE_RESOURCE_TYPE_NAME)
    {
        ...
        initial_amount_args.push_back(std::make_unique<riddle::id_expression>(std::vector<riddle::id_token>{riddle::id_token(CONSUMABLE_RESOURCE_INITIAL_AMOUNT_NAME, 0, 0, 0, 0)}));
        ctr_inits.emplace_back(riddle::id_token(CONSUMABLE_RESOURCE_INITIAL_AMOUNT_NAME, 0, 0, 0, 0), std::move(initial_amount_args));
        std::vector<std::unique_ptr<riddle::expression>> capacity_args;
        capacity_args.push_back(std::make_unique<riddle::id_expression>(std::vector<riddle::id_token>{riddle::id_token(CONSUMABLE_RESOURCE_CAPACITY_NAME, 0, 0, 0, 0)}));
        ctr_inits.emplace_back(riddle::id_token(CONSUMABLE_RESOURCE_CAPACITY_NAME, 0, 0, 0, 0), std::move(capacity_args));
        // we create the constructor's body..
        ctr_body.push_back(std::make_unique<riddle::expression_statement>(std::make_unique<riddle::geq_expression>(std::make_unique<riddle::id_expression>(std::vector<riddle::id_token>{riddle::id_token(CONSUMABLE_RESOURCE_INITIAL_AMOUNT_NAME, 0, 0, 0, 0)}), std::make_unique<riddle::real_expression>(riddle::real_token(utils::rational::zero, 0, 0, 0, 0)))));
        ctr_body.push_back(std::make_unique<riddle::expression_statement>(std::make_unique<riddle::geq_expression>(std::make_unique<riddle::id_expression>(std::vector<riddle::id_token>{riddle::id_token(CONSUMABLE_RESOURCE_CAPACITY_NAME, 0, 0, 0, 0)}), std::make_unique<riddle::real_expression>(riddle::real_token(utils::rational::zero, 0, 0, 0, 0)))));
        // we add the constructor to the consumable-resource type..
        add_constructor(std::make_unique<riddle::constructor>(*this, std::move(args), ctr_inits, ctr_body));
        ...
        // we create the `Produce` and `Consume` predicates' body..
        pred_body.push_back(std::make_unique<riddle::expression_statement>(std::make_unique<riddle::geq_expression>(std::make_unique<riddle::id_expression>(std::vector<riddle::id_token>{riddle::id_token(CONSUMABLE_RESOURCE_AMOUNT_NAME, 0, 0, 0, 0)}), std::make_unique<riddle::real_expression>(riddle::real_token(utils::rational::zero, 0, 0, 0, 0)))));
        pred_body.push_back(std::make_unique<riddle::expression_statement>(std::make_unique<riddle::leq_expression>(std::make_unique<riddle::id_expression>(std::vector<riddle::id_token>{riddle::id_token(CONSUMABLE_RESOURCE_AMOUNT_NAME, 0, 0, 0, 0)}), std::make_unique<riddle::id_expression>(std::vector<riddle::id_token>{riddle::id_token(CONSUMABLE_RESOURCE_CAPACITY_NAME, 0, 0, 0, 0)}))));
        // we create the `Produce` predicate..
        auto produce_pred = std::make_unique<riddle::predicate>(*this, CONSUMABLE_RESOURCE_PRODUCTION_PREDICATE_NAME, std::move(produce_args), pred_body);
        ...
        auto consume_pred = std::make_unique<riddle::predicate>(*this, CONSUMABLE_RESOURCE_CONSUMPTION_PREDICATE_NAME, std::move(consume_args), pred_body);
    ...
    void consumable_resource::new_atom(std::shared_ptr<ratio::atom> &atm)
    {
        ...
        if (!get_solver().get_sat().new_clause({!atm->get_reason().get_phi(), atm->get_sigma()}))
...
#ifdef COMPUTE_NAMES
            tl["name"] = get_solver().guess_name(*cres).c_str();
#endif
