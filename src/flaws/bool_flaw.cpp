...
namespace ratio::solver
{
    ...
    ORATIO_EXPORT std::string bool_flaw::get_data() const noexcept { return "{\"type\":\"bool\"}"; }
    ...
    ORATIO_EXPORT std::string bool_flaw::choose_value::get_data() const noexcept { return "{}"; }
