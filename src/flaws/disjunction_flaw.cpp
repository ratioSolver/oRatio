...
namespace ratio::solver
{
    ...
    ORATIOSOLVER_EXPORT json::json disjunction_flaw::get_data() const noexcept
    {
        json::json j_f;
    ...
    ORATIOSOLVER_EXPORT json::json disjunction_flaw::choose_conjunction::get_data() const noexcept { return json::object(); }
